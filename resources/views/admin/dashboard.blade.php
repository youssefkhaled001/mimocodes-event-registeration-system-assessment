<x-app-layout>
    <div class="py-16 px-8">
        <div class="max-w-7xl mx-auto">
            ...
            <!-- Header -->
            <div class="mb-12">
                <div class="inline-flex items-center gap-2 text-xs font-medium text-white/50 uppercase tracking-[0.15em] mb-4">
                ...
                <div class="p-8">
                    ...
                    @else
                        <div class="text-center py-16">
                            ...
                            <a href="/admin/create" class="inline-block px-6 py-3 bg-transparent border border-white/20 rounded-md text-white text-sm font-medium tracking-wide transition-all duration-300 hover:bg-cyan-500/10 hover:border-cyan-500/50 hover:text-cyan-400 hover:shadow-[0_0_20px_rgba(0,255,255,0.15)]">
                                + Create Event
                            </a>
                        </div>
                    @endif
