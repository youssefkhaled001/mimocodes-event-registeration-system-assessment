            ...
            <div class="bg-white/[0.02] backdrop-blur-sm border border-white/[0.08] rounded-xl overflow-hidden">
                <div class="p-8">
                    @if($registerations->count() > 0)
                        <x-table :columns="['Name', 'Email', 'Status', 'Payment Status']" :rows="$registerations->map(fn($registeration) => [
                                ...
                                :ids="$registerations->pluck('id')->toArray()"
                                :actions="[
                                    [
                    ...
                    @else
                            <div class="text-center py-16">
                                ...
                                <h3 class="font-serif text-2xl font-semibold text-white mb-2 tracking-tight">No Registerations Yet
                                </h3>
                            </div>
                        @endif
                </div>
